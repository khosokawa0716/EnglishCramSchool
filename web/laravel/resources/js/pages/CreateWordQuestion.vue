...
<div>
  <div v-if="page === 1">
    <v-form @submit.prevent="createWordQuestion">
      ...
      ></v-text-field>
      <v-text-field
        v-model="createWordQuestionForm.choices1"
        :rules="choicesRules"
        :counter="30"
        label="選択肢1"
        required
      ></v-text-field>
      <v-text-field
        v-model="createWordQuestionForm.choices2"
        :rules="choicesRules"
        :counter="30"
        label="選択肢2"
        required
      ></v-text-field>
      <v-text-field
        v-model="createWordQuestionForm.choices3"
        :rules="choicesRules"
        :counter="30"
        label="選択肢3"
        required
  ...
  <div v-else>
    ...
    <dt>選択肢1</dt>
    <dd>{{ createWordQuestionForm.choices1 }}</dd>
    <dt>選択肢2</dt>
    <dd>{{ createWordQuestionForm.choices2 }}</dd>
    <dt>選択肢3</dt>
    <dd>{{ createWordQuestionForm.choices3 }}</dd>
    <dt>正解の選択肢</dt>
